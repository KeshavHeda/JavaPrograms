...
//        }
        ...
        if(sellItem(customer1Basket, "car", 1) != 1) {
        ...
        Basket customer2Basket = new Basket("Customer2");
        sellItem(customer2Basket, "cup", 100);
        sellItem(customer2Basket, "juice", 5);
        removeItem(customer2Basket, "cup", 1);
        System.out.println(customer2Basket);

        removeItem(customer1Basket, "car", 1);
        removeItem(customer1Basket, "cup", 9);
        removeItem(customer1Basket, "car", 1);
        System.out.println("cars removed: " + removeItem(customer1Basket, "car", 1)); // no object removed
