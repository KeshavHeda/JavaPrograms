...
public class BankAccountInstance {
    ...
    public static void main(String[] args) {
        final BankAccountReEntrantLock account = new BankAccountReEntrantLock("12345-678", 1000);

        // Create Threads and handle run methods
...
//        };
        ...
        // Create Threads and handle runnable methods
